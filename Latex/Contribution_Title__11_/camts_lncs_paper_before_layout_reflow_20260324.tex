...
\begin{figure}[t]
\centering
\includegraphics[width=0.94\textwidth]{Architecture_diagram.png}
...
Patient-level analysis produced an internal AUC of 1.000 on a ten-patient cohort, with exact permutation p-values of 0.0040 one-sided and 0.0079 two-sided. This is encouraging, but it is still not external clinical proof because the cohort is small and internally sourced. The calibration summary in Fig.~\ref{fig:calib}, the robustness visualization in Fig.~\ref{fig:patient}, the clinical insight analysis in Fig.~\ref{fig:clinical}, and the patient-level signature heatmap in Fig.~\ref{fig:heatmap} therefore serve as cautionary context for the otherwise strong internal separation.
