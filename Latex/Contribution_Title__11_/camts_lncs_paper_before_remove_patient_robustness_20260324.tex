...
\captionof{figure}{Patient-level robustness analysis using exact permutation testing and leave-one-patient-out evaluation.}\label{fig:patientrobust}
\end{center}
\noindent Figure~\ref{fig:patientrobust} highlights that the patient-level signal is strong internally, but should still be treated as exploratory.
