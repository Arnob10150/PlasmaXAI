...
PATIENT_ROOT = ROOT / "data" / "raw" / "PCMMD Plasma Cells for Multiple Myeloma Diagnosis" / "PCMMD Plasma Cells for Multiple Myeloma Diagnosis" / "data" / "detection" / "patients"
PREV_OUTPUT_DIR = ROOT / "research" / "outputs" / "optimization"
...
def main():
    ...
    hybrid_cfg = json.loads((ROOT / "artifacts" / "models" / "best_plasmaxai_hybrid_config.json").read_text(encoding="utf-8"))
