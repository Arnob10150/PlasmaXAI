...
def main():
    ...
    summary = json.loads((ROOT / "novel_outputs" / "plasmaxai_operating_point.json").read_text(encoding="utf-8"))
    ...
    base_summary = json.loads((ROOT / "novel_outputs" / "novel_summary.json").read_text(encoding="utf-8"))
